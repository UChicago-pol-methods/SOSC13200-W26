...
Lecture materials, problem sets, and in-class code will be posted on the course GitHub page at \url{https://github.com/UChicago-pol-methods/SOSC13200-W26}. 
...
\begin{itemize}
\item On your own, set up the swirl course on ``R Programming with Email Notification'' \url{https://github.com/UChicago-pol-methods/R_Programming_E}
\item Run the following code: \texttt{install.packages(c("swirl"));} 
\texttt{library(swirl); }
\texttt{install\_course\_github("UChicago-pol-methods", "R\_Programming\_E"); }
\texttt{swirl()}
...
\textbf{Take-home midterm due Friday 2/6 at 11:59pm:}
Cumulative assessment of assignments 1--4.
...
\subsubsection*{Readings.}
\begin{itemize}
\item \bibentry{coppock2022power} \url{https://egap.org/resource/10-things-to-know-about-statistical-power/}
\item \bibentry{lakens2022samplesize}
\end{itemize}

\textbf{Homework 8 due Friday 2/27 at 11:59pm: Case File (Primary analysis + interpretation).}
...
\subsection*{Week 9: Pre-registration.}
...
\subsubsection*{Readings.}
\begin{itemize}
\item \bibentry{chen2021preanalysis} \url{https://egap.org/resource/10-things-to-know-about-pre-analysis-plans/}
\item \bibentry{offer2026frame}
\item \textbf{Optional/Reference:} \item \bibentry{monogan2015preregistration}
\end{itemize}

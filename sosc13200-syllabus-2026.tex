...
\item Run the following code: \texttt{install.packages(c("devtools","swirl")); devtools::install\_github("UChicago-pol-methods/swirl"); library(swirl); install\_course("R Programming E"); swirl()}

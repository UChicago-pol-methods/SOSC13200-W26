...
Did you take SOSC 13100 in fall quarter of 2025 (or an earlier year)?
...
\item Run basic statistical analysis in \texttt{R}
\end{itemize}
...
\begin{center}
{[}See \href{https://github.com/UChicago-pol-methods/SOSC13200-W26/blob/main/sosc13200-syllabus-2026.pdf}{syllabus} {]}
\end{center}
...
\begin{itemize}
\item Google! \pause
\item Ask on our course StackOverflow team: \url{https://stackoverflowteams.com/c/sosc13200-26-3} \pause {[}I'll send invites shortly{]}  \pause
...
\item Use Claude Code—our class has access to it!—for coding help as well.
\end{itemize}
...
\begin{itemize}
\item Homework: 24 points
\item Participation: 13 points
\item Midterm (in class): 18 points
\item Final (in person): 30 points
\item Final (take home): 15 points
\end{itemize}
...
\begin{itemize}
\item Download software--including Claude Code, if you are using it--on your own computer. \pause
...
\begin{itemize}
\item \url{https://github.com/UChicago-pol-methods/SOSC13200-W26}\pause
\item Serves as a repository for class documents. \pause
\item You don't need a GitHub account, nor do you need to know how to use git. \pause
\item But if you \textit{do} find mistakes in slides or homeworks, you can also get extra extra credit for submitting a pull request on GitHub with revisions. 
\end{itemize}
...
\begin{itemize}
\item Open the course project in RStudio.
\item Write code in an \texttt{.R} script instead of only in the console.
\item Run commands a line at a time so you can check what each step does.
\item Save your script with comments so you can rerun your work later.
\end{itemize}

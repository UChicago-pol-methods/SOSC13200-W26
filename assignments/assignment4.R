#' ---
#' title: "Assignment 4, Social Science Inquiry II (SOSC13200-W26-3)"
#' author: "<your name here>"
#' date: "Friday 1/30/26 at 11:59pm"
#' ---
#' Packages
library(ggplot2)
...
#' 
file <- "https://raw.githubusercontent.com/UChicago-pol-methods/SOSC13200-W26/main/data/angrist-krueger.csv"
dat <- read.csv(file, as.is = TRUE)

#' # 1. 
#' Consider Angrist and Krueger (1991) Table III Panel B on p. 996. 
